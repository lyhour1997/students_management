...
@section('content')
    <h2 class="py-3">Payments Form</h2>
    <hr class="pb-3">
        ...
        <div class="row">
            <div class="col-sm-9">
                    ...
                    <div class="col-sm-7 ">
                        <select required name="enrollment_id" class="form-control border-secondary">
                            ...
                            @foreach ($enrolls as $e)
                                <option value="{{$e->id}}">{{$e->enroll}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group row my-3">
                    ...
                    <div class="col-sm-7 ">
                        <input type="text" required name="paid_date" class="form-control border-secondary">
                    </div>
                </div>
                <div class="form-group row my-3">
                    <label for="amount" class="col-sm-3 fs-5">Amount</label>
                    <div class="col-sm-7 ">
                        <input type="text" required name="amount" class="form-control border-secondary">
                    </div>
                </div>
