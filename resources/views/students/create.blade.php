        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="form-group row my-3">
                    ...
                    <div class="col-sm-7 ">
                        <input type="text" required name="address" class="form-control border-secondary">
                    </div>
                </div>
                <div class="form-group row my-3">
                    <label for="mobile" class="col-sm-3 fs-5">Mobile</label>
                    <div class="col-sm-7 ">
                        <input type="text" required name="mobile" class="form-control border-secondary">
                    </div>
                </div>
                <div class="form-group row my-3">
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7 text-end ">
                        <a href="{{route('student.index')}}" class=" fw-bold btn btn-sm py-2 btn-primary">
