...
{{-- check conditon --}}
    ...
    <form action="{{route('batches.update', $edit->id)}}" method="POST">
        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="form-group row my-3">
                    ...
                    <div class="col-sm-7 ">
                        <select required name="course_id" class="form-control border-secondary">
                            ...
                            @foreach ($data as $d)
                                <option value="{{$d->id}}" {{$d->id == $edit->course_id ? 'selected' : ''}}>
                                    {{$d->name}}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row my-3">
                    ...
                    <div class="col-sm-7 ">
                        <input type="text" required name="start_date" value="{{$edit->start_date}}"
                        class="form-control border-secondary">
                    </div>
                </div>
